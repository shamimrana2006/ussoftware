...
export default function HomePartnersSection() {
  ...
  const partners: PartnerItem[] = [
    ...
    {
      id: "poly-18",
      name: "Army Institute of Business Administration (AIBA)",
      nameBn: "আর্মি ইনস্টিটিউট অব বিজনেস এডমিনিস্ট্রেশন (AIBA)",
      logo: "/our partner/New folder/18_polytechnic.webp",
      category: "collaboration",
      subtitle: "Affiliated with BUP & Army Welfare Trust",
      subtitleBn: "বিইউপি অধিভুক্ত প্রতিষ্ঠান",
      description: "Academic and technology collaboration for business analytics and IT leadership.",
      descriptionBn: "বিজনেস অ্যানালিটিক্স ও আইটি লিডারশিপের জন্য যৌথ একাডেমিক কোলাবোরেশন।",
      highlights: ["Business IT Labs", "Tech Leadership", "Career Grooming"],
      highlightsBn: ["বিজনেস আইটি ল্যাব", "টেক লিডারশিপ", "কেরিয়ার গ্রুমিং"]
    },
    {
      id: "poly-19",
      name: "Thakurgaon Polytechnic Institute",
      nameBn: "ঠাকুরগাঁও পলিটেকনিক ইনস্টিটিউট",
    ...
    {
      id: "poly-20",
      name: "Shyamoli Ideal Polytechnic Institute",
      nameBn: "শ্যামলী আইডিয়াল পলিটেকনিক ইনস্টিটিউট",
      logo: "/our partner/New folder/20_polytechnic.webp",
      category: "collaboration",
      subtitle: "Private Polytechnic Partner",
      subtitleBn: "বেসরকারি পলিটেকনিক ইনস্টিটিউট",
      description: "Hands-on industrial attachment and IT skill development for diploma engineers.",
      descriptionBn: "ডিপ্লোমা প্রকৌশলীদের বাস্তবমুখী ইন্ডাস্ট্রিয়াল অ্যাটাচমেন্ট ও আইটি স্কিল ডেভেলপমেন্ট।",
    ...
    {
      id: "poly-21",
      name: "National Professional Institute (NPI)",
      nameBn: "ন্যাশনাল প্রফেশনাল ইনস্টিটিউট (NPI)",
      logo: "/our partner/New folder/21_polytechnic.webp",
      category: "collaboration",
      subtitle: "Professional Polytechnic Partner",
      subtitleBn: "প্রফেশনাল পলিটেকনিক ইনস্টিটিউট",
    ...
    },
    {
      ...
      subtitle: "Government Polytechnic Partner",
      subtitleBn: "সরকারি পলিটেকনিক ইনস্টিটিউট",
      description: "Practical coding bootcamps and industrial project guidance for diploma engineers.",
    ...
    },
    {
      ...
      nameBn: "মাগুরা পলিটেকনিক ইনস্টিটিউট",
    ...
    },
    {
      ...
      nameBn: "ময়মনসিংহ পলিটেকনিক ইনস্টিটিউট",
    ...
    },
    {
      ...
      nameBn: "লক্ষ্মীপুর পলিটেকনিক ইনস্টিটিউট",
    ...
    },
    {
      ...
      nameBn: "কিশোরগঞ্জ পলিটেকনিক ইনস্টিটিউট",
    ...
    },
    {
      ...
      nameBn: "গ্রীনল্যান্ড পলিটেকনিক ইনস্টিটিউট",
      logo: "/our partner/New folder/28_polytechnic.webp",
      category: "collaboration",
      subtitle: "Private Polytechnic Partner",
      subtitleBn: "বেসরকারি পলিটেকনিক ইনস্টিটিউট",
      description: "Practical software training and career empowerment for computer technology students.",
    ...
    {
      id: "poly-30",
      name: "Darpon Polytechnic Institute",
      nameBn: "দর্পণ পলিটেকনিক ইনস্টিটিউট",
      logo: "/our partner/New folder/30_polytechnic.webp",
      category: "collaboration",
      subtitle: "Technical Institute Partner",
      subtitleBn: "কারিগরি শিক্ষা প্রতিষ্ঠান",
      description: "Industrial attachment and skill development program for computer science students.",
    ...
    },
    {
      ...
      category: "collaboration",
      subtitle: "Premier Government Polytechnic",
      subtitleBn: "ঐতিহ্যবাহী সরকারি পলিটেকনিক",
    ...
    },
    {
      ...
      nameBn: "ঢাকা মহিলা পলিটেকনিক ইনস্টিটিউট",
      logo: "/our partner/New folder/33_polytechnic.webp",
      category: "collaboration",
      subtitle: "Women's Polytechnic Partner",
      subtitleBn: "মহিলা পলিটেকনিক ইনস্টিটিউট",
      description: "Empowering female engineers with modern software engineering and coding bootcamps.",
      descriptionBn: "নারী প্রকৌশলীদের আধুনিক সফটওয়্যার ইঞ্জিনিয়ারিং ও কোডিং বুটক্যাম্পের মাধ্যমে ক্ষমতায়ন।",
      highlights: ["Women in Tech", "Placement Guidance", "Practical Coding"],
      highlightsBn: ["উইমেন ইন টেক", "প্লেসমেন্ট গাইডেন্স", "প্র্যাকটিক্যাল কোডিং"]
    },
    {
      id: "poly-34",
      name: "Daffodil Polytechnic Institute (DPI)",
      nameBn: "ড্যাফোডিল পলিটেকনিক ইনস্টিটিউট (DPI)",
      logo: "/our partner/New folder/34_polytechnic.webp",
      category: "collaboration",
      subtitle: "Leading Private Polytechnic",
      subtitleBn: "শীর্ষ বেসরকারি পলিটেকনিক",
    ...
    },
    {
      ...
      nameBn: "চাঁপাইনবাবগঞ্জ পলিটেকনিক ইনস্টিটিউট",
    ...
    {
      id: "poly-37",
      name: "AMDA Institute of Engineering & Technology (AIET)",
      nameBn: "আমদা ইনস্টিটিউট অব ইঞ্জিনিয়ারিং অ্যান্ড টেকনোলজি (AIET)",
      logo: "/our partner/New folder/37_polytechnic.webp",
      category: "collaboration",
      subtitle: "Engineering & Tech Institute",
      subtitleBn: "প্রকৌশল ও কারিগরি প্রতিষ্ঠান",
      description: "Industrial training program for computer technology students.",
    ...
    {
      id: "poly-38",
      name: "Ahsanullah Institute of TVET (AITVET)",
      nameBn: "আহছানউল্লা ইনস্টিটিউট অব টিভিইটি (AITVET)",
      logo: "/our partner/New folder/38_polytechnic.webp",
      category: "collaboration",
      subtitle: "AUST Affiliated TVET Institute",
      subtitleBn: "আহছানউল্লা মিশন পরিচালিত টিভিইটি",
